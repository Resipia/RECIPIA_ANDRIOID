...
data class RecipeCreateUpdateRequestDto(
    ...
    val nutritionalInfo: com.recipia.aos.ui.api.dto.recipe.NutritionalInfoDto,   // 영양소 dto
    val subCategoryDtoList: List<com.recipia.aos.ui.api.dto.SubCategoryDto>,   // 카테고리
